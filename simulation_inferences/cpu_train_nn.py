...
results_file = open("true_epidemic/true_epidemic.pkl", "rb")
true_results = pickle.load(results_file)["results"]
results_file.close()
len_output = len(true_results) # When doing time inference, there's actually two elements to the output (the output and the times)	
...
num_features = 15
num_param = 2
compressor_layers = [len_output, 400, 200, 100, 50, num_features]
mdn_layers = [num_features, 15,  num_components]
