...
for i in range(lower, upper):
    directory_num = i
    output_file_path = root + "output/" + str(mode) + "_output_data_" + str(directory_num) + ".npy"
    theta_file_path = root + "theta/" + str(mode) + "_theta_data_" + str(directory_num) + ".npy"
    network_params_file_path = root + "network_params/" + str(mode) + "_network_params_data_" + str(directory_num) + ".npy"
...
if num_found > 0:
    ...
    unified_output_path = root + str(mode) + "_unified_output_shard_" + str(job_id) + ".npy"
    unified_theta_path = root + str(mode) + "_unified_theta_shard_" + str(job_id) + ".npy"
    unified_network_params_path = root + str(mode) + "_unified_network_params_shard_" + str(job_id) + ".npy"
